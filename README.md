...
```
microservices/
├── preauthorize.feature    # Стартовая страница
├── login.feature           # Аутентификация
├── register.feature        # Регистрация
├── menu.feature            # Просмотр меню
├── product_card.feature    # Карточка товара
├── cart.feature            # Корзина
├── order.feature           # Создание заказа
├── profile.feature         # Профиль пользователя
├── бизнес_идея.txt         # Описание бизнес-идеи
